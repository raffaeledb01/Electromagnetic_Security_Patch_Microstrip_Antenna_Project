...
data_RE = [
3.0000000000000	61.442745000155;
3.0000000000000	61.442745000155;
3.5000000000000	64.459646458005;
4.0000000000000	67.199856207051;
4.5000000000000	69.768357886574;
5.0000000000000	72.246648108714;
5.0000000000000	72.246648108714;
5.5000000000000	74.711095400921;
6.0000000000000	77.239340560118;
6.5000000000000	79.924893504871;
7.0000000000000	82.889025214759;
7.0000000000000	82.889025214759;
]
...
% Plot RE
plot(x_RE, y_RE, '-o', 'LineWidth', 1.5, 'MarkerSize', 6, 'Color', 'b', 'DisplayName', 'DM Radiated E-field at 10 m');
...
yticklabels(string(sort(Efield, 'ascend'))); % Convert the ticks to strings 
